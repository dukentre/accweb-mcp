...
func accParameterDocs() []accParameterDoc {
	return []accParameterDoc{
		...
		{File: "configuration.json", Path: "acc.configuration.registerToLobby", Type: "integer", Description: "Whether the server registers to the ACC lobby.", Values: []string{"0", "1"}},
		...
		{File: "configuration.json", Path: "acc.configuration.publicIP", Type: "string", Description: "Optional public IP override."},
		...
		{File: "event.json", Path: "acc.event.cloudLevel", Type: "number", Description: "Cloud level from 0 to 1."},
		{File: "event.json", Path: "acc.event.rain", Type: "number", Description: "Rain level from 0 to 1."},
		{File: "event.json", Path: "acc.event.weatherRandomness", Type: "integer", Description: "Weather randomness level."},
		{File: "event.json", Path: "acc.event.sessions", Type: "array", Description: "Race weekend sessions."},
